...
async function setGroupDescription(sock, chatId, senderId, text, message) {
    ...
    try {
        ...
        await sock.sendMessage(chatId, { text: '✔️ Group description updated.' }, { quoted: message });
    } catch (e) {
...
async function setGroupName(sock, chatId, senderId, text, message) {
    ...
    try {
        ...
        await sock.sendMessage(chatId, { text: '✔️ Group name updated.' }, { quoted: message });
    } catch (e) {
...
async function setGroupPhoto(sock, chatId, senderId, message) {
    ...
    try {
        ...
        await sock.sendMessage(chatId, { text: '✔️ Group profile photo updated.' }, { quoted: message });
    } catch (e) {
