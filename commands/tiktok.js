        ...
        try {
                        ...
                        for (let i = 0; i < Math.min(20, mediaData.length); i++) {
                            ...
                            if (isVideo) {
                                await sock.sendMessage(chatId, {
                                    video: { url: mediaUrl },
                                    mimetype: "video/mp4",
                                    caption: "𝗗𝗢𝗪𝗡𝗟𝗢𝗔𝗗𝗘𝗗 𝗕𝗬 𝘼𝘾𝙃𝘼𝙆𝙕𝘼𝙄 04 𝙈𝘿𝗧"
                                }, { quoted: message });
                            } else {
                                await sock.sendMessage(chatId, {
                                    image: { url: mediaUrl },
                                    caption: "𝗗𝗢𝗪𝗡𝗟𝗢𝗔𝗗𝗘𝗗 𝗕𝗬 𝘼𝘾𝙃𝘼𝙆𝙕𝘼𝙄 04 𝙈𝘿"
                                }, { quoted: message });
                            }
                        }
                        return;
            ...
            if (videoUrl) {
                try {
                    ...
                    const caption = title ? `𝗗𝗢𝗪𝗡𝗟𝗢𝗔𝗗𝗘𝗗 𝗕𝗬 𝘼𝘾𝙃𝘼𝙆𝙕𝘼𝙄 04 𝙈𝘿\n\n📝 Title: ${title}` : "𝗗𝗢𝗪𝗡𝗟𝗢𝗔𝗗𝗘𝗗 𝗕𝗬 𝘼𝘾𝙃𝘼𝙆𝙕𝘼𝙄 04 𝙈𝘿";
