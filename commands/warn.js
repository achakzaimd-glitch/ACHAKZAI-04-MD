...
async function warnCommand(sock, chatId, senderId, mentionedJids, message) {
    try {
        ...
        try {
            ...
            if (!isBotAdmin) {
                await sock.sendMessage(chatId, { 
                    text: '❌ 𝙀𝙧𝙧𝙤𝙧: 𝙋𝙡𝙚𝙖𝙨𝙚 𝙢𝙖𝙠𝙚 𝙩𝙝𝙚 𝙗𝙤𝙩 𝙖𝙣 𝙖𝙙𝙢𝙞𝙣 𝙛𝙞𝙧𝙨𝙩 𝙩𝙤 𝙪𝙨𝙚 𝙩𝙝𝙞𝙨 𝙘𝙤𝙢𝙢𝙖𝙣𝙙.'
                });
                return;
            }
            ...
            if (!isSenderAdmin) {
                await sock.sendMessage(chatId, { 
                    text: '❌ 𝙀𝙧𝙧𝙤𝙧: 𝙊𝙣𝙡𝙮 𝙜𝙧𝙤𝙪𝙥 𝙖𝙙𝙢𝙞𝙣𝙨 𝙘𝙖𝙣 𝙪𝙨𝙚 𝙩𝙝𝙚 𝙬𝙖𝙧𝙣 𝙘𝙤𝙢𝙢𝙖𝙣𝙙.'
                });
                return;
            }
        } catch (adminError) {
            ...
            await sock.sendMessage(chatId, { 
                text: '❌ 𝙀𝙧𝙧𝙤𝙧: 𝙋𝙡𝙚𝙖𝙨𝙚 𝙢𝙖𝙠𝙚 𝙨𝙪𝙧𝙚 𝙩𝙝𝙚 𝙗𝙤𝙩 𝙞𝙨 𝙖𝙣 𝙖𝙙𝙢𝙞𝙣 𝙤𝙛 𝙩𝙝𝙞𝙨 𝙜𝙧𝙤𝙪𝙥.'
            });
            return;
        }
        ...
        if (!userToWarn) {
            await sock.sendMessage(chatId, { 
                text: '❌ 𝙀𝙧𝙧𝙤𝙧: 𝙋𝙡𝙚𝙖𝙨𝙚 𝙢𝙚𝙣𝙩𝙞𝙤𝙣 𝙩𝙝𝙚 𝙪𝙨𝙚𝙧 𝙤𝙧 𝙧𝙚𝙥𝙡𝙮 𝙩𝙤 𝙩𝙝𝙚𝙞𝙧 𝙢𝙚𝙨𝙨𝙖𝙜𝙚 𝙩𝙤 𝙬𝙖𝙧𝙣!'
            });
            return;
        }
